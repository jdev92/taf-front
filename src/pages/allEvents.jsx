                              ...
                              (event, index) =>
                                ...
                                event.presentDays.length > 0 && (
                                  <tr key={event._id || index}>
                                    ...
                                    <td className="px-4 py-4 text-white text-sm dark:text-gray-300 whitespace-nowrap bg-gray-900 ">
                                      {event.title}
                                    </td>
                                    <td className="text-green-500  px-4 py-4 text-sm  whitespace-nowrap bg-gray-900 ">
                                      {event.start}
                                    </td>
                                    <td className="px-4 py-4 text-sm text-red-500 whitespace-nowrap bg-gray-900">
                                      {event.end}
                                    </td>
                                    <td className="px-4 py-4 text-sm text-blue-500 whitespace-nowrap bg-gray-900 ">
